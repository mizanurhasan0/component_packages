...
export default function SliderCard({ slide, index, itemCount, currentIdx }: SliderCardProps): JSX.Element | ReactNode {
    ...
    const styles = {
        now: 'transform -translate-x-1/2 -translate-y-1/2 scale-100 opacity-100 z-[5]',
        next: 'transform -translate-y-1/2 -translate-x-[135%] scale-[0.8] opacity-50 brightness-75 z-[1]',
        prev: 'transform -translate-y-1/2 translate-x-[35%] scale-[0.8] opacity-50 brightness-90 z-[1]',
