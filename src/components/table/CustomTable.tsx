...
import { HeadersTypes, TablePropsType } from './table_types/TblType';
...
//     loading: boolean;
// };
const HeadersList: HeadersTypes = {
...
export default function CustomTable({ headers = 'header1' }: TablePropsType) {
